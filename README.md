...
Каждая клетка вселенной может находиться в двух состояниях: живой (зеленой) и мёртвой (пустой/белой).
Для наглядности добавлено третье состояние (бордовое) - клетка выделяется, если на предыдущем шаге она была живой, а на этом стала мёртвой.
